...
public class AdminCuentasDao extends BaseDao {
    public ArrayList<Albergue> listarAlbergues() {
        ...
        String sql = "SELECT * FROM albergue where eliminado = 0 and aprobado = 1";
    ...
    public ArrayList<Albergue> solisAlbergue() {
        ArrayList<Albergue> listaAlbergues = new ArrayList<>();
        String sql = "SELECT * FROM albergue where eliminado = 0 and aprobado = 0";
    ...
    public ArrayList<Usuario> listarUsuarios() {
        ...
        String sql = "SELECT * FROM usuario where eliminado = 0 and activo = 1";
    ...
    public ArrayList<Usuario> solisUsuarios() {
        ArrayList<Usuario> listaUsuarios = new ArrayList<>();
        String sql = "SELECT * FROM usuario where eliminado = 0 and activo = 0";
    ...
    public void aceptarAlbergue(int albergueid){
        String sql = "update albergue set aprobado = 1 where albergueID = ?";
        try (Connection conn = this.getConnection();
             PreparedStatement pstmt = conn.prepareStatement(sql)){
            pstmt.setInt(1,albergueid);
            pstmt.executeUpdate();
    ...
    public void rechazarAlbergue(int albergueid){
        String sql = "update albergue set aprobado = 0 where albergueID = ?";
        try (Connection conn = this.getConnection();
             PreparedStatement pstmt = conn.prepareStatement(sql)){
            pstmt.setInt(1,albergueid);
            pstmt.executeUpdate();
    ...
    public void aceptarUsuario(int userid){
        String sql = "update usuario set activo = 1 where usuarioID = ?";
        try (Connection conn = this.getConnection();
             PreparedStatement pstmt = conn.prepareStatement(sql)){
    ...
    public void desactivarUsuario(int userid){
        String sql = "update usuario set activo = 0 where usuarioID = ?";
        try (Connection conn = this.getConnection();
             PreparedStatement pstmt = conn.prepareStatement(sql)){
            pstmt.setInt(1,userid);
            pstmt.executeUpdate();

                                ...
                                <div class="row">
                                  ...
                                  <div class="col-12 col-sm-6 col-md-4 col-lg-3 mb-4">
                                    <div class="card h-100">
                                      <img src="/common/img/perdidos/perdido4.jpg" class="card-img-top" alt="Evento 1">
                                      <div class="card-body">
                                        <h4 class="card-title text-center">Max</h4>
                                        <hr>
                                  ...
                                  <div class="col-12 col-sm-6 col-md-4 col-lg-3 mb-4">
                                    <div class="card h-100">
                                      <img src="/common/img/perdidos/perdido8.jpg" class="card-img-top" alt="Evento 2">
                                      <div class="card-body">
                                  ...
                                  <div class="col-12 col-sm-6 col-md-4 col-lg-3 mb-4">
                                    <div class="card h-100">
                                      <img src="/common/img/perdidos/perdido1.jpg" class="card-img-top" alt="Evento 3">
                                      <div class="card-body">
                                  ...
                                  <div class="col-12 col-sm-6 col-md-4 col-lg-3 mb-4">
                                    <div class="card h-100">
                                      ...
                                      <div class="card-body">
                                        <h4 class="card-title text-center">Rocky</h4>
                                        <hr>
                                        <div style="display: flex; justify-content: center;">
                                            <a href="albergueVisAdop.jsp"><button type="button" class="btn btn-personal2" style="margin-right: 3px; border-width: 1px;" title="Visualizar"><span class="fi fi-rr-eye"></button></a>
                                                <a href="albergueEdAdop.jsp"><button type="button" class="btn btn-personal2" style="margin-right: 3px; border-width: 1px;" title="Editar"><span class="fi fi-rr-edit"></button></a>
                                  ...
                                  <div class="col-12 col-sm-6 col-md-4 col-lg-3 mb-4">
                                    <div class="card h-100">
                                      <img src="/common/img/perdidos/perdido2.jpg" class="card-img-top" alt="Evento 3">
                                      <div class="card-body">
                                        <h4 class="card-title text-center">Milo</h4>
                                        <hr>
                                        <div style="display: flex; justify-content: center;">
                                            <a href="albergueVisAdop.jsp"><button type="button" class="btn btn-personal2" style="margin-right: 3px; border-width: 1px;" title="Visualizar"><span class="fi fi-rr-eye"></button></a>
                                                <a href="albergueEdAdop.jsp"><button type="button" class="btn btn-personal2" style="margin-right: 3px; border-width: 1px;" title="Editar"><span class="fi fi-rr-edit"></button></a>
                                  ...
                                  <div class="col-12 col-sm-6 col-md-4 col-lg-3 mb-4">
                                    <div class="card h-100">
                                      ...
                                      <div class="card-body">
                                        <h4 class="card-title text-center">Simba</h4>
                                        <hr>
                                        <div style="display: flex; justify-content: center;">
                                            <a href="albergueVisAdop.jsp"><button type="button" class="btn btn-personal2" style="margin-right: 3px; border-width: 1px;" title="Visualizar"><span class="fi fi-rr-eye"></button></a>
                                                <a href="albergueEdAdop.jsp"><button type="button" class="btn btn-personal2" style="margin-right: 3px; border-width: 1px;" title="Editar"><span class="fi fi-rr-edit"></button></a>
                                  ...
                                  <div class="col-12 col-sm-6 col-md-4 col-lg-3 mb-4">
                                    <div class="card h-100">
                                      ...
                                      <div class="card-body">
                                        <h4 class="card-title text-center">Bella</h4>
                                        <hr>
                                        <div style="display: flex; justify-content: center;">
                                            <a href="albergueVisAdop.jsp"><button type="button" class="btn btn-personal2" style="margin-right: 3px; border-width: 1px;" title="Visualizar"><span class="fi fi-rr-eye"></button></a>
                                                <a href="albergueEdAdop.jsp"><button type="button" class="btn btn-personal2" style="margin-right: 3px; border-width: 1px;" title="Editar"><span class="fi fi-rr-edit"></button></a>
                                  ...
                                  <div class="col-12 col-sm-6 col-md-4 col-lg-3 mb-4">
                                    <div class="card h-100">
                                      ...
                                      <div class="card-body">
                                        <h4 class="card-title text-center">Toby</h4>
                                        <hr>
                                        <div style="display: flex; justify-content: center;">
                                            <a href="albergueVisAdop.jsp"><button type="button" class="btn btn-personal2" style="margin-right: 3px; border-width: 1px;" title="Visualizar"><span class="fi fi-rr-eye"></button></a>
                                                <a href="albergueEdAdop.jsp"><button type="button" class="btn btn-personal2" style="margin-right: 3px; border-width: 1px;" title="Editar"><span class="fi fi-rr-edit"></button></a>
                                  ...
                                  <div class="col-12 col-sm-6 col-md-4 col-lg-3 mb-4">
                                    <div class="card h-100">
                                      ...
                                      <div class="card-body">
                                        <h4 class="card-title text-center">Chester</h4>
                                        <hr>
                                        <div style="display: flex; justify-content: center;">
                                            <a href="albergueVisAdop.jsp"><button type="button" class="btn btn-personal2" style="margin-right: 3px; border-width: 1px;" title="Visualizar"><span class="fi fi-rr-eye"></button></a>
                                                <a href="albergueEdAdop.jsp"><button type="button" class="btn btn-personal2" style="margin-right: 3px; border-width: 1px;" title="Editar"><span class="fi fi-rr-edit"></button></a>
                                  ...
                                  <div class="col-12 col-sm-6 col-md-4 col-lg-3 mb-4">
                                    <div class="card h-100">
                                      <img src="/common/img/perdidos/perdido4.jpg" class="card-img-top" alt="Evento 4">
                                      <div class="card-body">
                                        <h4 class="card-title text-center">Lola</h4>
                                        <hr>
                                        <div style="display: flex; justify-content: center;">
                                            <a href="albergueVisAdop.jsp"><button type="button" class="btn btn-personal2" style="margin-right: 3px; border-width: 1px;" title="Visualizar"><span class="fi fi-rr-eye"></button></a>
                                                <a href="albergueEdAdop.jsp"><button type="button" class="btn btn-personal2" style="margin-right: 3px; border-width: 1px;" title="Editar"><span class="fi fi-rr-edit"></button></a>
                    ...
                    <div class="container d-flex justify-content-center mt-1">
                        <div class="row">
                            <nav aria-label="...">
                                <ul class="pagination">
                                  <li class="page-item ">
                                    <a class="page-link" href="adoptionTable.jsp">Anterior</a>
                                  </li>
                                  <li class="page-item"><a class="page-link" href="adoptionTable.jsp">1</a></li>
                                  ...
                                  <li class="page-item">
                                    <a class="page-link" href="adoptionTable3.jsp">Siguiente</a>
                                  </li>
                                </ul>
                              </nav>
                        </div>

                                ...
                                <div class="row">
                                  ...
                                  <div class="col-12 col-sm-6 col-md-4 col-lg-3 mb-4">
                                    <div class="card h-100">
                                      ...
                                      <div class="card-body">
                                        <h4 class="card-title text-center">Oreo</h4>
                                        <hr>
                                  ...
                                  <div class="col-12 col-sm-6 col-md-4 col-lg-3 mb-4">
                                    <div class="card h-100">
                                      ...
                                      <div class="card-body">
                                        <h4 class="card-title text-center">Bobby</h4>
                                        <hr>
                                        <div style="display: flex; justify-content: center;">
                                            <a href="albergueVisAdop.jsp"><button type="button" class="btn btn-personal2" style="margin-right: 3px; border-width: 1px;" title="Visualizar"><span class="fi fi-rr-eye"></button></a>
                                                <a href="albergueEdAdop.jsp"><button type="button" class="btn btn-personal2" style="margin-right: 3px; border-width: 1px;" title="Editar"><span class="fi fi-rr-edit"></button></a>
                                  ...
                                  <div class="col-12 col-sm-6 col-md-4 col-lg-3 mb-4">
                                    <div class="card h-100">
                                      ...
                                      <div class="card-body">
                                        <h4 class="card-title text-center">Zeus</h4>
                                        <hr>
                                        <div style="display: flex; justify-content: center;">
                                            <a href="albergueVisAdop.jsp"><button type="button" class="btn btn-personal2" style="margin-right: 3px; border-width: 1px;" title="Visualizar"><span class="fi fi-rr-eye"></button></a>
                                                <a href="albergueEdAdop.jsp"><button type="button" class="btn btn-personal2" style="margin-right: 3px; border-width: 1px;" title="Editar"><span class="fi fi-rr-edit"></button></a>
                    ...
                    <div class="container d-flex justify-content-center mt-5">
                        <div class="row">
                            <nav aria-label="...">
                                <ul class="pagination">
                                  <li class="page-item ">
                                    <a class="page-link" href="adoptionTable2.jsp">Anterior</a>
                                  </li>
                                  ...
                                  <li class="page-item disabled">
                                    <span class="page-link active">Siguiente</span>
                                  </li>
                                </ul>
                              </nav>
                        </div>

...
<head>
    ...
    <title>Visualizar formulario de donación</title>
    <style>
                ...
                <div class="row" id="contenido-nofooter" style="flex-grow: 1;align-content:center">
                    ...
                    <div class="container md-8" style="width: 85%;max-width: 800px; background-color:#eb903b76; border-radius: 30px; padding: 0 20px;">
                        <form id="uploadForm" style="padding:10px" >
                            <h1 style="margin-top: 10px;" class="text-center">Visualiza tus Avisos de Donación</h1>
                            <div class="row justify-content-center p-1">
                                
                                <div class="col-md-6 p-1">
                                    <label for="tipo_donacion">Donación</label>
                                    <select class="form-select" id="tipo_donacion" aria-label="Floating label select example" disabled onchange="toggleInputs()">
                                        <option >Seleccione el tipo de donación necesitada</option>
                                        <option value="alimenticia">Alimenticia</option>
                                        <option value="medica">Médica</option>
                                        <option  selected value="monetaria">Monetaria</option>
                            ...
                            <div class="row justify-content-center p-1">
                                ...
                                <div class="col-md-8 p-1">
                                    ...
                                    <input type="text" class="form-control" placeholder="Av. San Juan 123" maxlength="100" id="Direccion" name="Direccion" disabled>
                                </div>
                            </div>
                            <div class="row justify-content-center p-1">
                                <div class="col-md-6 p-1">
                                    <label for="inicio">Hora Inicio</label>
                                    <input type="time" class="form-control" id="inicio"  required onchange="validarHoras()" disabled>
                                </div>
                                <div class="col-md-6 p-1">
                                    <label for="fin">Hora Fin</label>
                                    <input type="time" class="form-control" id="fin"  required onchange="validarHoras()" disabled>
                                </div>
                            </div>
                            <div class="row justify-content-center p-1">
                                <div class="col-md-6 p-1">
                                    <label for="num_contacto">Número de contacto para la donación</label>
                                    <input type="number" class="form-control" id="num_contacto" oninput="validarNumero()" placeholder="909303101" disabled>
                                </div>
                                <div class="col-md-6 p-1">
                                    <label for="num_yape">Número de donación (en caso sea monetaria)</label>
                                    <input type="number" class="form-control" id="num_yape" oninput="validarNumero2()" placeholder="999000999" disabled>
                                </div>
                            </div>
                            <div class="row justify-content-center p-1">
                                <div class="col-md-12 p-1">
                                    <label for="correo">Correo Electrónico</label>
                                    <input type="email" class="form-control" id="correo" placeholder="mail@gmail.com" disabled>
                                </div>
                            </div>
                            <div class="row justify-content-center p-1">
                                <div class="col-md-12 p-1">
                                <label for="mensaje"> Breve Mensaje a los Donantes (200 caracteres maximo)</label>
                                <textarea name="" id="mensaje" maxlength="200" class="form-control" placeholder="El siguiente mensaje para los donantes" disabled></textarea>
                                </div>
                            </div>
                            <div class="row justify-content-center p-1">
                            ...
                            <div class="row justify-content-center p-1">
                                <div class="col-md-12 p-1 d-flex justify-content-center">
                                    <a href="donationTable.jsp"><button type="button" class="btn btn-personal">Cerrar</button></a>
                                </div>

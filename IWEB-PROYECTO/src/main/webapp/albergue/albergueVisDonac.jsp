...
<div class="contenedor-p">
    ...
    <header class="cabecera">
        <div class="izquierda" onclick="toggleMenu()">
            ...
            <div class="welcome-text">Hola, <%=donacionSuministros.getAlbergue().getNombreAlbergue()%> Patitas Felices</div>
        </div>
                    ...
                    <form id="uploadForm" style="padding:10px" method="POST" action="<%=request.getContextPath()%>/DonacionSuministros?action=edit">
                        ...
                        <div class="row justify-content-center p-1">
                            ...
                            <div class="row justify-content-center p-1">
                                <div class="col-md-6 p-1">
                                    ...
                                    <input value="<%=donacionSuministros.getTituloAvisoDonacion()%>" name="titulo" type="text" class="form-control" id="titulo_donacion" placeholder="Ingrese el título"  maxlength="50" required disabled>
                                </div>
                                <div class="col-md-6 p-1">
                                    <label for="correo">Correo Electrónico del albergue</label>
                                    <input value="<%=donacionSuministros.getCorreoElectronicoDonacion()%>" name="correo" type="email" class="form-control" id="correo" placeholder="Ingrese su correo de contacto para donaciones" required disabled>
                            ...
                            <div class="col-md-6 p-1">
                                ...
                                <select name="tipo" class="form-select" id="tipo_donacion" aria-label="Floating label select example" required onchange="toggleInput()" disabled>
                            ...
                            <div class="col-md-6 p-1">
                                ...
                                <input value="<%=donacionSuministros.getNombreSuministro()%>" name="nombreSuministro" type="text" class="form-control" id="otra-donacion" maxlength="50" required disabled>
                            </div>
                        ...
                        <div class="row justify-content-center p-1">
                            <div class="col-md-6 p-1">
                                ...
                                <input value="<%=donacionSuministros.getCantidadDonacionesTotales()%>" name="cantidad" type="number" class="form-control" id="cant_donacion" oninput="validarNumero()" placeholder="Ingrese la cantidad requerida" required disabled>
                            </div>
                            <div class="col-md-6 p-1">
                                <label for="marca_donacion">Especifique la marca (opcional)</label>
                                <input value="<%=donacionSuministros.getMarcaSuministro()%>" name="marca" type="text" class="form-control" id="marca_donacion" placeholder="Ingrese la marca o marcas (use comas)" disabled>
                            </div>
                        </div>
                        ...
                        <div class="row justify-content-center p-1">
                            <div class="col-md-4 p-1" >
                                ...
                                <input name="nombreDistrito" value="<%=donacionSuministros.getDistrito().getNombreDistrito()%>" type="text" class="form-control" id="distritoNombre" disabled>
                            ...
                            <div class="col-md-8 p-1">
                                ...
                                <input value="<%=donacionSuministros.getAlbergue().getPuntoAcopioDonaciones()%>" type="text" class="form-control" placeholder="Maximo 100 caracteres" maxlength="100" id="Direccion" disabled>
                            </div>
                        </div>
                        ...
                        <div class="row justify-content-center p-1">
                            <div class="col-md-6 p-1">
                                ...
                                <input value="<%=donacionSuministros.getFechaInicioRecepcion()%>" name="fechaini" type="date" class="form-control" id="fecha_inicio_donacion" required disabled>
                            </div>
                            <div class="col-md-6 p-1">
                                <label for="fecha_fin_donacion">Fecha fin</label>
                                <input value="<%=donacionSuministros.getFechaFinRecepcion()%>" name="fechafin" type="date" class="form-control" id="fecha_fin_donacion" required disabled>
                            </div>
                        </div>
                        ...
                        <div class="row justify-content-center p-1">
                            <div class="col-md-6 p-1">
                                ...
                                <input value="<%=donacionSuministros.getHoraInicioRecepcion()%>" name="horaini" type="time" class="form-control" id="inicio" placeholder="Ingrese la hora de inicio" required onchange="validarHoras()" disabled>
                            </div>
                            <div class="col-md-6 p-1">
                                <label for="fin">Hora Fin</label>
                                <input value="<%=donacionSuministros.getHoraFinRecepcion()%>" name="horafin" type="time" class="form-control" id="fin" placeholder="Ingrese la hora de fin" required onchange="validarHoras()" disabled>
                            </div>
                        </div>
                        ...
                        <div class="row justify-content-center p-1">
                            <div class="col-md-6 p-1">
                                ...
                                <input value="<%=donacionSuministros.getAlbergue().getNombreContactoDonaciones()%>" type="text" class="form-control" id="nombre_contacto" placeholder="Ingrese el nombre de la persona" maxlength="80" disabled>
                            </div>
                            <div class="col-md-6 p-1">
                                <label for="num_contacto">Número de contacto para la donación</label>
                                <input value="<%=donacionSuministros.getAlbergue().getNumeroContactoDonaciones()%>" type="number" class="form-control" id="num_contacto" oninput="validarNumero()" placeholder="Ingrese el número de contacto" disabled>
                            </div>
                        </div>
                        ...
                        <div class="row justify-content-center p-1">
                            <div class="col-md-12 p-1">
                                ...
                                <textarea name="breve" id="mensaje" maxlength="200" class="form-control" placeholder="Ingrese un mensaje para los donantes" disabled><%=donacionSuministros.getMensajeParaDonantes()%></textarea>
                            </div>
                        </div>
                        <%--div class="row justify-content-center p-1">

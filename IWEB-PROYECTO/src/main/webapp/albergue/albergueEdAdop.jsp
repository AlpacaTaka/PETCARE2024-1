                        ...
                        <form id="uploadForm" style="padding:10px" method="POST" action="${pageContext.request.contextPath}/PortalAdopciones" enctype="multipart/form-data">
                            ...
                            <div class="row justify-content-center p-1">
                                <div class="col-md-6 p-1">
                                    ...
                                    <input id="nombreMascota" name="nombreMascota" value="<%=mascota.getNombreMascota()%>" type="text" class="form-control" placeholder="Ingrese el nombreMascota de la mascota" maxlength="21" required>
                                </div>
                                <div class="col-md-6 p-1">
                            ...
                            <div class="row justify-content-center p-1">
                                ...
                                <div class="col-md-8 p-1">
                                    ...
                                    <input type="text" value="<%=mascota.getDireccionHallazgo()%>" class="form-control" placeholder="Maximo 100 caracteres" maxlength="100" id="Direccion" name="direccionHallazgo">
                                </div>
                            </div>
                            <div class="row justify-content-center p-1">
                                <div class="col-md-7 p-1">
                                    <label for="edad">Edad Aproximada</label>
                                    <input type="number" value="<%=mascota.getEdadAprox()%>" class="form-control" id="edad" name="edad" placeholder="Ingrese edad" required>
                                </div>
                                <div class="col-md-5 p-1 ">
                                    ...
                                    <div style="margin-top: 5px;" class="col-md-12 d-flex justify-content-around align-self-center">
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="sexoMascota" id="flexRadioDefault1" <%String sexo= mascota.getSexo().equals("Macho") ? "checked" : "";%><%=sexo%> value="Macho">
                                            <label class="form-check-label" for="flexRadioDefault1">
                                                Macho
                                            </label>
                                        </div>
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="sexoMascota" id="flexRadioDefault2" <%sexo= mascota.getSexo().equals("Hembra") ? "checked" : "";%><%=sexo%> value="Hembra">
                            ...
                            <div class="row justify-content-center p-1">
                                <div class="col-md-12 p-1">
                                    ...
                                    <textarea name="breveDescripcion" id="breve" class="form-control" placeholder="Ingrese una breve descripcion de la mascota" maxlength="300" required><%=mascota.getDescripcionGeneral()%></textarea>
                                </div>
                            </div>
                            <div class="row justify-content-center p-1">
                            ...
                            <div class="row justify-content-center p-1">
                                <div class="col-md-5 p-1 ">
                                    ...
                                    <div style="margin-top: 5px;" class="col-md-12 d-flex justify-content-around align-self-center">
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="hogarTemp" id="flexRadioDefault3" <%String isTemporal= mascota.isSeEncuentraTemporal() ? "checked" : "";%><%=isTemporal%> value="true">
                                            <label class="form-check-label" for="flexRadioDefault3">
                                                Si
                                            </label>
                                        </div>
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="hogarTemp" id="flexRadioDefault4" <%isTemporal= !mascota.isSeEncuentraTemporal() ? "checked" : "";%><%=isTemporal%> value="false">
                                ...
                                <div class="col-md-7 p-1">
                                    ...
                                    <input type="text" id="condiciones" value="<%=mascota.getCondicionesAdopcion()%>" class="form-control" placeholder="Maximo 100 caracteres" maxlength="100" name="condiciones">
                                </div>
                            </div>
                            <div class="row justify-content-center p-1">

        ...
        <div class="container-fluid d-flex" id="contenido-principal">
            ...
            <div class="row" id="contenido-nofooter" style="flex-grow: 1;align-content:center">
                <div class="container md-8" style="width: 85%;max-width: 800px; background-color:#eb903b76; border-radius: 30px; padding: 0 20px;">
                    <form id="uploadForm" style="padding:10px" method="POST" action="<%=request.getContextPath()%>/CrearCoordinador?action=view" >
                        ...
                        <div class="row justify-content-center p-1">
                            <div class="col-md-6 p-1">
                                ...
                                <input type="text" class="form-control" value="<%=zona.getNombre()%>" placeholder="Ingrese sus nombres" id="Nombre-coordinador" name="NombreCoordinador" maxlength="40" disabled>
                            </div>
                            <div class="col-md-6 p-1">
                                <label for="Apellido-coordinador">Apellidos</label>
                                <input type="text" class="form-control" value="<%=zona.getApellido()%>" placeholder="Ingrese los apellidos" id="Apellido-coordinador" name="ApellidoCoordinador" maxlength="50" disabled>
                            </div>
                        </div>
                        ...
                        <div class="row justify-content-center p-1">
                            <div class="col-md-5 p-1">
                                ...
                                <input type="number" class="form-control" value="<%=zona.getCelular()%>" id="celular-coordinador" placeholder="Ingrese su número de celular" name="celuCoordinador" disabled>
                            </div>

                            <div class="col-md-7 p-1">
                                <label for="correo-coordinador">Correo electrónico</label>
                                <input type="email" class="form-control" value="<%=zona.getCorreoElectronico()%>" name="correoCoordinador" id="correo-coordinador" min="10" max="254" placeholder="Ingrese el correo electrónico" disabled>
                        ...
                        <div class="row justify-content-center p-1">
                            <div class="col-md-5 p-1">
                                ...
                                <input type="number" class="form-control" value="<%=zona.getDni()%>" id="dni-coordinador" name="dniCoordinador" placeholder="Ingrese el número de DNI" disabled>
                            </div>

                            <div class="col-md-4 p-1">
                                <label for="zona-asignada">Zona Asignada</label>
                                <select class="form-select" name="zonaID" id="zona-asignada" aria-label="Floating label select example" disabled>
                            ...
                            <div class="col-md-3 p-1">
                                ...
                                <input type="date" class="form-control" value="<%=zona.getFechaNacimiento()%>"  id="fechaNacimineto" name="fechaNacimiento" disabled>
                            </div>

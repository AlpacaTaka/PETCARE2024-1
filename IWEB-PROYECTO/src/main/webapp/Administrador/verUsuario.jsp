            ...
            <form id="uploadForm" style="padding:10px" >
              ...
              <div class="row justify-content-center p-1">
                ...
                <div class="col-md-6 p-1">
                  ...
                  <input type="text" id="nombre" class="form-control" placeholder="Juan" required disabled>
                </div>
                <div class="col-md-6 p-1">
                  <label for="apellido">Apellido</label>
                  <input type="text" id="apellido" class="form-control" placeholder="Guerrero Adrianzen" required disabled>
                </div>
              ...
              <div class="row justify-content-center p-1">
                <div class="col-md-4 p-1">
                  ...
                  <input type="number" id="documentoIdentidad" class="form-control" placeholder="03203852" required disabled>
              ...
              <div class="row justify-content-center p-1">
                <div class="col-md-12 p-1" >
                  ...
                  <input type="text" id="direccion" class="form-control" placeholder="Calle Parque San Martin 252 Dpto. 501" required disabled>
                </div>
              ...
              <div class="row justify-content-center p-1">
                <div class="col-md-12 p-1" >
                  ...
                  <input type="email" id="correo" class="form-control" placeholder="tubebitofiufiu@gmail.com" required disabled>
                </div>

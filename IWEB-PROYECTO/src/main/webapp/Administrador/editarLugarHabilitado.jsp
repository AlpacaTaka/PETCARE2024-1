    ...
    <div class="container-fluid d-flex" id="contenido-principal">
      ...
      <div class="row" id="contenido-nofooter" style="flex-grow: 1;align-content:center">
        ...
        <div class="container md-8" style="width: 85%;max-width: 800px; background-color:#eb903b76; border-radius: 30px; padding: 0 20px;">
          <form id="uploadForm" style="padding:10px" method="POST" action="<%=request.getContextPath()%>/LugarHabilitado?action=edit" >
            <input type="hidden" name="id" value="<%=lugar.getLugarID()%>">
            <h1 style="margin-top: 10px;" class="text-center">Edición de Lugar Habilitado</h1>
            <!--Primera fila de selección-->
            <div class="row justify-content-center p-1">
              <div class="col-md-12 p-1">
                <label for="Nombre-lugar">Nombre del lugar</label>
                <input type="text" class="form-control" value="<%=lugar.getNombreLugar()%>" placeholder="Ingrese el nombre del lugar" id="Nombre-lugar" name="nombreLugar" maxlength="50" required>
              </div>
            </div>
            ...
            <div class="row justify-content-center p-1">
              ...
              <div class="col-md-8 p-1">
                ...
                <input type="text" class="form-control" value="<%=lugar.getDireccionLugar()%>" placeholder="Maximo 100 caracteres" maxlength="100" id="Direccion" name="direccionLugar">
              </div>
            </div>
            ...
            <div class="row justify-content-center p-1">
              <div class="col-md-4 p-1">
                ...
                <input type="number" class="form-control" name="aforoLugar" value="<%=lugar.getAforoMax()%>" id="aforo-maximo" style="margin-top: 6px;" placeholder="Ingrese una cantidad" min="50" max="800" required>
              </div>

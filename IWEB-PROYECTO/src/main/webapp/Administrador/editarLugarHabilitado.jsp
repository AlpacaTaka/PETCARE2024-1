          ...
          <form id="uploadForm" style="padding:10px" >
            ...
            <div class="row justify-content-center p-1">
              <div class="col-md-12 p-1">
                ...
                <input type="text" class="form-control" placeholder="Estadio Lolo Fernadez" id="Nombre-lugar" name="Nombre-lugar" maxlength="50" required>
              </div>
            </div>
            ...
            <div class="row justify-content-center p-1">
              <div class="col-md-12 p-1">
                ...
                <input type="text" class="form-control" id="direccion-lugar" maxlength="100" placeholder="Av Aguarico 133" required>
              </div>
            </div>
            ...
            <div class="row justify-content-center p-1">
              <div class="col-md-4 p-1">
                ...
                <input type="number" class="form-control" id="aforo-maximo" style="margin-top: 6px;" placeholder="300" min="50" max="800" required>
              </div>

                ...
                <div class="col" id="contenido-nofooter">
                    ...
                    <div class="container md-8" style="width: 85%; max-width: 800px; background-color:#eb903b76; border-radius: 30px; padding: 0 20px; display: flex; justify-content: center; align-items: center;">
                        <div class="card-body" style="width: 100%; text-align: center; padding: 10px 50px;">
                            <h2 class="card-title" style="margin-top: 10px;">EXPOMASCOTAS</h2>
                            <div style="display: flex; justify-content: center; margin-top: 10px; ">
                                <img src="/common/img/eventos/evento6.jpg" class="card-img-eve" alt="Imagen" style="width: 100%; max-width: 100%; height: auto; border-radius: 15px;">
                            </div>
                            <div class="badge text-bg-secondary text-wrap" style="margin-top: 10px; font-size: 1.5rem; padding: 10px 20px;">
                                25 Sep. 08:00am
                            </div>                            

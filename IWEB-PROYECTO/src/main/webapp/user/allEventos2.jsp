                            ...
                            <div class="row">
                                ...
                                <div class="col-12 col-md-6 col-lg-4 mb-4">
                                    <div class="card h-100">
                                        <img src="/common/img/eventos/evento10.png" class="card-img-top" alt="Card 1">
                                        <div class="card-body">
                                ...
                                <div class="col-12 col-md-6 col-lg-4 mb-4">
                                    <div class="card h-100">
                                        <img src="/common/img/eventos/evento9.png" class="card-img-top" alt="Card 1">
                                        <div class="card-body">
                                            <div class="row d-flex justify-content-center">
                                                <div class="badge text-bg-primary text-wrap" style="max-width: 70%; margin-bottom: 10px">
                                                    25 Sep. 08:00am
                                ...
                                <div class="col-12 col-md-6 col-lg-4 mb-4">
                                    <div class="card h-100">
                                        <img src="/common/img/eventos/evento8.jpg" class="card-img-top" alt="Card 1">
                                        <div class="card-body">
                                            <div class="row d-flex justify-content-center">
                                                <div class="badge text-bg-primary text-wrap" style="max-width: 70%; margin-bottom: 10px">
                                                    25 Sep. 08:00am
                        ...
                        <div class="container d-flex justify-content-center mt-5">
                            <div class="row">
                                <nav aria-label="...">
                                    <ul class="pagination">
                                      <li class="page-item ">
                                        <a class="page-link" href="allEventos.jsp">Anterior</a>
                                      </li>
                                      <li class="page-item"><a class="page-link" href="allEventos.jsp">1</a></li>
                                      ...
                                      <li class="page-item">
                                        <a class="page-link" href="allEventos3.jsp">Siguiente</a>
                                      </li>
                                    </ul>
                                  </nav>
                            </div>

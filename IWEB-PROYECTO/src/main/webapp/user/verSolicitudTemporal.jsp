...
<body>
    <div class="contenedor-p">
                ...
                <div class="col" id="contenido-nofooter">
                    ...
                    <div class="container md-8" style="width: 85%;max-width: 800px; background-color:#eb903b76; border-radius: 30px; padding: 0 20px;">
                        <form id="uploadForm"style="padding:10px">
                            <h1 style="margin-top: 10px;" class="text-center">Ver mi Solicitud</h1>
                            <br>
                            <!--Primera columna de selección-->
                            <div class="row justify-content-center p-1">
                                <div class="col-md-6 p-1">                         
                                    <label for="Nombre-temporal">Nombres</label>
                                    <input type="text" class="form-control" placeholder="Juan Carlos" id="Nombre-temporal" name="Nombre-temporal" maxlength="40" required disabled>      
                                </div>
                                <div class="col-md-6 p-1">
                                    <label for="Apellido-temporal">Apellidos</label>
                                    <input type="text" class="form-control" placeholder="Pacheco" id="Apellido-temporal" name="Apellido-temporal" maxlength="50" required disabled> 
                                </div>
                            </div>
                            ...
                            <div class="row justify-content-center p-1">
                                <div class="col-md-5 p-1">
                                    ...
                                    <input type="number" class="form-control" id="edad" min="14" max="90" placeholder="20" style="appearance: none; -moz-appearance: textfield;" required disabled>
                                </div>
                                <div class="col-md-7 p-1 ">
                                    <label for="Sexo">Género</label>
                                    <div class="col-md-12 d-flex justify-content-around align-self-center">
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="genero" id="flexRadioDefault1" disabled>
                                            <label class="form-check-label" for="flexRadioDefault1">
                                            Masculino
                                            </label>
                                        </div>
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="genero" id="flexRadioDefault2" checked disabled>
                                            <label class="form-check-label" for="flexRadioDefault2">
                                            Femenino
                                            </label>
                                        </div>
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="genero" id="flexRadioDefault3" checked  disabled>
                            ...
                            <div class="row justify-content-center p-1">
                                <div class="col-md-8 p-1">
                                    ...
                                    <input type="text" class="form-control" placeholder="Av Universitaria" maxlength="100" id="Direccion" name="Direccion" required disabled>
                               </div>
                               <div class="col-md-4 p-1" >
                                    <label for="distrito">Distrito</label>
                                    <select class="form-select" name="distrito" id="distrito" required disabled>
                                        <option value="" disabled selected>Jesus Maria</option>
                            ...
                            <div class="row justify-content-center p-1">
                                <div class="col-md-5 p-1">
                                    ...
                                    <input type="number" class="form-control" id="celular" placeholder="987654321" required disabled>
                                </div>
                                <div class="col-md-3 p-1">
                                    <label for="cantidad-cuartos">Cantidad de cuartos</label>
                                    <input type="number" class="form-control" id="cantidad-cuartos" min="1" max="5" placeholder="3" required disabled>
                                </div>
                                <div class="col-md-4 p-1">
                                    <label for="metraje-casa">Metraje de la vivienda <strong>(m²)</strong></label>
                                    <input type="number" class="form-control" id="metraje-casa" min="30" max="300" placeholder="250" required disabled>
                                </div>
                            </div>
                            ...
                            <div class="row justify-content-center p-1">
                                <div class="col-md-2 p-1 ">
                                    ...
                                    <div class="col-md-12 d-flex justify-content-around align-self-center">
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="tieneHijos" id="flexRadioDefault1" disabled>
                                            <label class="form-check-label" for="flexRadioDefault1">
                                            Si
                                            </label>
                                        </div>
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="tieneHijos" id="flexRadioDefault2" checked disabled>
                                            <label class="form-check-label" for="flexRadioDefault2">
                                            No
                                            </label>
                                        </div>
                                ...
                                <div class="col-md-4 p-1 ">
                                    ...
                                    <div class="col-md-12 d-flex justify-content-around align-self-center">
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="viveSolo" id="flexRadioDefault1" disabled>
                                            <label class="form-check-label" for="flexRadioDefault1">
                                            Solo
                                            </label>
                                        </div>
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="viveSolo" id="flexRadioDefault2" checked disabled>
                                            <label class="form-check-label" for="flexRadioDefault2">
                                            Con dependientes
                                            </label>
                                        </div>
                                ...
                                <div class="col-md-6 p-1 ">
                                    ...
                                    <div class="col-md-12 d-flex justify-content-around align-self-center">
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="modoTrabajo" id="flexRadioDefault1" disabled>
                                            <label class="form-check-label" for="flexRadioDefault1">
                                            Remoto
                                            </label>
                                        </div>
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="modoTrabajo" id="flexRadioDefault2" checked disabled>
                                            <label class="form-check-label" for="flexRadioDefault2">
                                            Presencial
                                            </label>
                                        </div>
                            ...
                            <div class="row justify-content-center p-1">
                                <div class="col-md-5 p-1 ">
                                    ...
                                    <div class="col-md-12 d-flex justify-content-around align-self-center">
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="tieneMascotas" id="flexRadioDefault1" value="si" disabled>
                                            <label class="form-check-label" for="flexRadioDefault1">
                                            Si
                                            </label>
                                        </div>
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="tieneMascotas" id="flexRadioDefault2" value="no" checked disabled>
                                            <label class="form-check-label" for="flexRadioDefault2">
                                            No
                                            </label>
                                        </div>
                            ...
                            <div class="row justify-content-center p-1">
                                <div class="col-md-8 p-1">                         
                                    ...
                                    <input type="text" class="form-control" placeholder="Juan" id="Nombre-referncia" name="Nombre-referncia" maxlength="70" required disabled>      
                                </div>
                                <div class="col-md-4 p-1">
                                    <label for="celular-referencia">Celular</label>
                                    <input type="number" class="form-control" id="celular-referencia" placeholder="987654321" required disabled>
                                </div>
                            </div>
                            ...
                            <div class="row justify-content-center p-1">
                                <div class="col-md-12 p-1">
                                    ...
                                    <input class="form-control" type="file" id="formFileMultiple" multiple accept=".png" onchange="validateFiles(this)" onchange="mostrarNombreArchivo()" required disabled>
                            ...
                            <div class="row justify-content-center p-1">
                                <div class="col-md-6 p-1">
                                    ...
                                    <input type="number" class="form-control" id="tiempo-temporal" placeholder="12" min="2" max="104" required disabled>
                                </div>
                                <div class="col-md-3 p-1">
                                    <label for="fechaInicio">Fecha de inicio:</label><br>
                                    <input type="date"  class="form-control" id="fechaInicio" name="fechaInicio" required disabled> 
                                </div>
                                <div class="col-md-3 p-1">
        ...
        <script> // Simulamos que el archivo ya fue seleccionado 
            function mostrarNombreArchivo() { 
                const inputFile = document.getElementById('formFileMultiple'); 
                const fileName = document.getElementById('formFileMultiple'); 
                // Si hay archivos seleccionados, los mostramos 
                if (inputFile.files.length > 0) { 
                    fileName.textContent = inputFile.files[0].name; 
                } 
            } 
            // Simulamos un archivo seleccionado 
            document.getElementById('formFileMultiple').textContent = "3_archivos_seleccionados"; 
        </script>
    </body>
</html>
            ...
            <div class="container-fluid d-flex" id="contenido-principal">
                ...
                <div class="col" id="contenido-nofooter">
                    <div class="container md-8 d-flex justify-content-between" style="width: 85%;max-width: 800px; margin-bottom: 20px; padding: 0;">
                        ...
                        <button type="button"  class="btn btn-personal" onclick="location.href='${pageContext.request.contextPath}/Inicio'">  Ver todas postulaciones   </button>
                    </div>
                    <div class="container md-12" style="width: 85%;max-width: 800px; background-color: #fca6519f; border-radius: 30px; margin-bottom: 20px; padding: 10px 20px;">
                        ...
                        <p style="margin: 5px 20px" class="text-center">Permitenos seguir ayudando a perritos y gatitos, postula como hogar temporal y aloja a un lindo amigo de 4 patas.
                            Completa el siguiente cuestionario de forma honesta para seguir con el proceso!</p><br>
                    </div>
